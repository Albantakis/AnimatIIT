...
if strcmp(tpm_choice,'State X State')
    ...
    for i = 1:tpm_size_new
        names{i} = char(trans2(i-1,nNodes)'+'0');
    end
...
elseif strcmp(tpm_choice,'State X Node') 
    ...
    for i = 1:2^nNodes
        row_names{i} = char(trans2(i-1,nNodes)'+'0');
    end
...
optionVector_phi = [2,1,0,3];
op_big_phi = optionVector_phi(get(handles.big_phi_alg_menu,'Value'));
...
if strcmp(tpm_choice,'State X State') && size(tpm,2) == num_nodes
    ...
    for i = 1:num_states
        for j = 1:num_states
            ...
            state = num2str(char(trans2(j-1,num_nodes)'+'0'));
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% All network option functions that are used                              %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%Larissa: TODO: What to do when freezing??
%--------------------------------------------------------------------------
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% All network option functions that are not used                          %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
